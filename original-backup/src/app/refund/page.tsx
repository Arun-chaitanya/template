...
export const metadata = {
  title: 'Refund Policy | WriteFast',
  description: 'Refund Policy for the WriteFast application',
};
    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <section>
          ...
          <p>
            At WriteFast, we stand behind the quality of our service and want you to be completely satisfied with your subscription. 
        ...
        <section>
          ...
          <p>
            To request a refund, please email us at <a href="mailto:arunchaitanya.iitkgp@gmail.com">arunchaitanya.iitkgp@gmail.com</a> with the following information:
          </p>
          <ul>
